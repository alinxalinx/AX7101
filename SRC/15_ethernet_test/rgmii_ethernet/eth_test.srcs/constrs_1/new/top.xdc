...
#set_input_delay -clock e1_rx_clk -max 3 [get_ports e1_rxdv]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports e1_rxdv]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports e1_rxer]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports e1_rxer]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[0]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[0]}]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[1]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[1]}]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[2]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[2]}]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[3]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[3]}]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[4]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[4]}]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[5]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[5]}]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[6]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[6]}]

#set_input_delay -clock e1_rx_clk -max 3 [get_ports {e1_rxd[7]}]
#set_input_delay -clock e1_rx_clk -min 2 [get_ports {e1_rxd[7]}]
...
#set_output_delay -clock e1_tx_clk -max 3 [get_ports e1_txen]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports e1_txen]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports e1_txer]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports e1_txer]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[0]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[0]}]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[1]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[1]}]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[2]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[2]}]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[3]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[3]}]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[4]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[4]}]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[5]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[5]}]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[6]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[6]}]

#set_output_delay -clock e1_tx_clk -max 3 [get_ports {e1_txd[7]}]
#set_output_delay -clock e1_tx_clk -min 0 [get_ports {e1_txd[7]}]
...
#set_input_delay -clock e3_rx_clk -max 3 [get_ports e3_rxdv]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports e3_rxdv]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports e3_rxer]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports e3_rxer]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[0]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[0]}]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[1]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[1]}]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[2]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[2]}]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[3]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[3]}]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[4]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[4]}]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[5]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[5]}]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[6]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[6]}]

#set_input_delay -clock e3_rx_clk -max 3 [get_ports {e3_rxd[7]}]
#set_input_delay -clock e3_rx_clk -min 2 [get_ports {e3_rxd[7]}]
...
#set_output_delay -clock e3_tx_clk -max 3 [get_ports e3_txen]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports e3_txen]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports e3_txer]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports e3_txer]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[0]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[0]}]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[1]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[1]}]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[2]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[2]}]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[3]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[3]}]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[4]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[4]}]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[5]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[5]}]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[6]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[6]}]

#set_output_delay -clock e3_tx_clk -max 3 [get_ports {e3_txd[7]}]
#set_output_delay -clock e3_tx_clk -min 0 [get_ports {e3_txd[7]}]
...
#set_input_delay -clock e4_rx_clk -max 3 [get_ports e4_rxdv]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports e4_rxdv]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports e4_rxer]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports e4_rxer]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[0]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[0]}]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[1]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[1]}]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[2]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[2]}]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[3]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[3]}]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[4]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[4]}]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[5]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[5]}]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[6]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[6]}]

#set_input_delay -clock e4_rx_clk -max 3 [get_ports {e4_rxd[7]}]
#set_input_delay -clock e4_rx_clk -min 2 [get_ports {e4_rxd[7]}]
...
#set_output_delay -clock e4_tx_clk -max 3 [get_ports e4_txen]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports e4_txen]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports e4_txer]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports e4_txer]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[0]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[0]}]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[1]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[1]}]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[2]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[2]}]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[3]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[3]}]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[4]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[4]}]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[5]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[5]}]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[6]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[6]}]

#set_output_delay -clock e4_tx_clk -max 3 [get_ports {e4_txd[7]}]
#set_output_delay -clock e4_tx_clk -min 0 [get_ports {e4_txd[7]}]
