...
#
# Generated by Vivado on Mon Sep 11 14:50:18 +0800 2017
...
# Script info
echo -e "sys_pll.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./sys_pll.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../ddr3_ov5640_an070_lcd.srcs/sources_1/ip/sys_pll/sys_pll_clk_wiz.v" \
    "$ref_dir/../../../../ddr3_ov5640_an070_lcd.srcs/sources_1/ip/sys_pll/sys_pll.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.sys_pll xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.sys_pll -input simulate.do
}
# Script usage
usage()
{
