...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../ddr3_ov5640_an070_lcd.srcs/sources_1/ip/afifo_16i_64o_512/sim/afifo_16i_64o_512.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.afifo_16i_64o_512 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.afifo_16i_64o_512 -input simulate.do
}
# Script usage
usage()
{
