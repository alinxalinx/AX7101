...
#set_property IOB true [get_ports {vga_out_r[*]}]
#set_property IOB true [get_ports {vga_out_g[*]}]
#set_property IOB true [get_ports {vga_out_b[*]}]
#set_property SLEW FAST [get_ports {vga_out_r[*]}]
#set_property SLEW FAST [get_ports {vga_out_g[*]}]
#set_property SLEW FAST [get_ports {vga_out_b[*]}]
