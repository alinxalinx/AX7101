...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../ddr3_ov5640_an070_lcd.srcs/sources_1/ip/afifo_64i_16o_128/sim/afifo_64i_16o_128.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.afifo_64i_16o_128 $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.afifo_64i_16o_128 -input simulate.do
}
# Script usage
usage()
{
