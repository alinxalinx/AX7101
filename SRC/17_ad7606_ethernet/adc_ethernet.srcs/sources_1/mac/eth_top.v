...
wire [31:0]           destination_ip_addr      ;
 (* MARK_DEBUG="true" *)wire [7:0]            udp_data                 ;
 (* MARK_DEBUG="true" *)wire                  udp_tx_req               ;
 (* MARK_DEBUG="true" *)wire                  arp_request_req          ;
 (* MARK_DEBUG="true" *)wire                  mac_send_end             ;
 (* MARK_DEBUG="true" *)wire [7:0]            udp_rec_ram_rdata        ;
wire [10:0]           udp_rec_ram_read_addr    ;
wire [15:0]           udp_rec_data_length      ;
 (* MARK_DEBUG="true" *)wire                  udp_rec_data_valid       ;
 (* MARK_DEBUG="true" *)wire                  mac_not_exist            ;
 (* MARK_DEBUG="true" *)wire                  arp_found                ;

wire [7:0]            reply_data               ;
wire [31:0]           sample_num               ;
wire                  cmd_reply_ack            ;
 (* MARK_DEBUG="true" *)wire                  cmd_reply_req            ;     //cmd reply request
wire [15:0]           cmd_send_len             ;       //cmd reply length
wire                  ad_data_ack              ;
 (* MARK_DEBUG="true" *)wire                  ad_data_req              ;       //ad data request
