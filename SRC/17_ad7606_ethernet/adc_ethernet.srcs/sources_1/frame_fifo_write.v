...
(
	...
	(* MARK_DEBUG="true" *)output reg                          write_finish,               // data write module write request finish
	...
	(* MARK_DEBUG="true" *)input[15:0]                      rdusedw                     // from fifo read used words
);
...
(* MARK_DEBUG="true" *)reg                                 write_req_d2;                //third,Why do you need 3 ? Here's the design habit
...
(* MARK_DEBUG="true" *)reg[ADDR_BITS - 1:0]                write_len_latch;             //lock write data length
(* MARK_DEBUG="true" *)reg[ADDR_BITS - 1:0]                write_cnt;                   //write data counter
